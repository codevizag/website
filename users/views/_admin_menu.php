  ...
  <aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?=$us_url_root?>"><img src="images/logo.png" alt="Logo"></a>
      ...
      <div id="main-menu" class="main-menu collapse navbar-collapse">
        <ul class="nav navbar-nav">
         <li <?=($view) ? '' : 'class="active"' ;?>>
            <a href="admin"> <i class="menu-icon fa fa-dashboard"></i><?=lang("BE_DASH")?> </a>
          </li>
          ...
          <li class="menu-item-has-children dropdown <?=activeDropdown($view, 'settings')[0];?>">
            ...
            <ul class="sub-menu children dropdown-menu <?=activeDropdown($view, 'settings')[0];?>">
              <?php if(checkAccess('view','general')){?> <li <?=($view == 'general') ? 'class="active"' : '' ;?>><i class="menu-icon fa fa-gears"></i><a href="admin?view=general"><?=lang("BE_GEN")?></a></li><?php } ?>
              <?php if(checkAccess('view','reg')){?> <li <?=($view == 'reg') ? 'class="active"' : '' ;?>><i class="menu-icon fa fa-users"></i><a href="admin?view=reg"><?=lang("BE_REG")?></a></li><?php } ?>
              <?php if(checkAccess('view','email')){?> <li <?=($view == 'email') ? 'class="active"' : '' ;?>><i class="menu-icon fa fa-envelope"></i><a href="admin?view=email"><?=lang("GEN_EMAIL")?></a></li><?php } ?>
              <?php if(checkAccess('view','nav')){?> <li <?=($view == 'nav') ? 'class="active"' : '' ;?> ><i class="menu-icon fa fa-list-alt"></i><a href="admin?view=nav">Navigation</a></li><?php } ?>
              <?php if($settings->custom_settings == 1){?> <li <?=($view == 'custom') ? 'class="active"' : '' ;?>><i class="menu-icon fa fa-snowflake-o"></i><a href="admin?view=custom"><?=lang("BE_CUS")?></a></li><?php } ?>
              <?php if(in_array($user->data()->id, $master_account)){?> <li <?=($view == 'access') ? 'class="active"' : '' ;?>><i class="menu-icon fa fa-file-code-o"></i><a href="admin?view=access"><?=lang("BE_DASH_ACC")?></a></li><?php } ?>
            </ul>
          </li>
        <?php } //end settings menu admin only?>
          <li class="menu-item-has-children dropdown <?=activeDropdown($view, 'tools')[0];?>">
            ...
            <ul class="sub-menu children dropdown-menu <?=activeDropdown($view, 'tools')[0];?>">
              <?php if(checkAccess('view','backup')){?> <li <?=($view == 'backup') ? 'class="active"' : '' ;?>><i class="menu-icon fa fa-floppy-o"></i><a href="admin?view=backup"><?=lang("BE_BACKUP")?></a></li><?php } ?>
              <?php if(in_array($user->data()->id,$master_account)){?> <li <?=($view == 'bugs') ? 'class="active"' : '' ;?>><i class=" menu-icon fa fa-bug"></i><a href="admin?view=bugs">Bug Reporter</a></li><?php } ?>
              <?php if(checkAccess('view','updates')){?> <li <?=($view == 'updates') ? 'class="active"' : '' ;?>><i class="menu-icon fa fa-arrow-circle-o-up"></i><a href="admin?view=updates"><?=lang("BE_UPDATE")?></a></li><?php } ?>
              <?php if(checkAccess('view','cron')){?> <li <?=($view == 'cron') ? 'class="active"' : '' ;?>><i class="menu-icon fa fa-terminal"></i><a href="admin?view=cron"><?=lang("BE_CRON")?></a></li><?php } ?>
              <?php if(checkAccess('view','ip')){?> <li <?=($view == 'ip') ? 'class="active"' : '' ;?>><i class="menu-icon fa fa-warning"></i><a href="admin?view=ip"><?=lang("BE_IP")?></a></li><?php } ?>
              <?php if(checkAccess('view','logs')){?> <li <?=($view == 'logs') ? 'class="active"' : '' ;?>><i class="menu-icon fa fa-list-ol"></i><a href="admin?view=logs">System Logs</a></li><?php } ?>
              <?php if(checkAccess('view','templates')){?> <li <?=($view == 'templates') ? 'class="active"' : '' ;?>><i class=" menu-icon fa fa-eye"></i><a href="admin?view=templates">Templates</a></li><?php } ?>
            </ul>
          </li>
<?php //dump($plugins); ?>
          ...
          <li class="menu-item-has-children dropdown <?=activeDropdown($view, 'addons')[0];?>">
            ...
            <ul class="sub-menu children dropdown-menu <?=activeDropdown($view, 'addons')[0];?>">
              <?php if(checkAccess('view','plugins')){?>   <li <?=($view == 'plugins') ? 'class="active"' : '' ;?>><i class="menu-icon fa fa-plug"></i><a href="admin?view=plugins">Plugin Manager</a></li><?php } ?>
              <?php foreach($plugins as $t){
                ...
                <li><i class=" menu-icon fa fa-bolt"></i>
                  <a href="<?=$us_url_root.'users/admin?view=plugins_config&plugin='.$t?>" >
                    <?php
                    if($xml->button != ''){
                      echo $xml->button;
                    }else{
          ...
          <?php if(file_exists($abs_us_root.$us_url_root.'usersc/includes/admin_panels.php')){ ?>
            <?php if(checkAccess('view','stats')){?> <li <?=($view == 'stats') ? 'class="active"' : '' ;?>>
                <a href="admin?view=legacy"><i class="menu-icon fa fa-clock-o"></i>Legacy Buttons</a>
            </li>
          <?php } }?>
          <li class="menu-title">Manage</li><!-- /.menu-title -->
            <?php if(checkAccess('view','pages')){?> <li <?=($view == 'pages') ? 'class="active"' : '' ;?>><a href="admin?view=pages"><i class="menu-icon fa fa-file"></i>Pages</a></li><?php } ?>
            <?php if(checkAccess('view','permissions')){?> <li <?=($view == 'permissions') ? 'class="active"' : '' ;?>><a href="admin?view=permissions"><i class="menu-icon fa fa-lock"></i>Permission Levels</a></li><?php } ?>
            <?php if(in_array($user->data()->id,$master_account)){?> <li <?=($view == 'spice') ? 'class="active"' : '' ;?>><a href="admin?view=spice"><i class="menu-icon fa fa-user-secret"></i>Spice Shaker</a></li><?php } ?>
            <?php if(checkAccess('view','users')){?> <li <?=($view == 'users') ? 'class="active"' : '' ;?>><a href="admin?view=users"><i class="menu-icon fa fa-user"></i>Users</a></li><?php } ?>
          ...
          <li class="menu-item">
            ...
            <a href="<?=$us_url_root?>"><i class="menu-icon fa fa-home"></i>Visit Homepage</a>
            <a href="<?=$us_url_root?>users/account"><i class="menu-icon fa fa-qq"></i>Your Account</a>
            <a href="<?=$us_url_root?>users/logout"><i class="menu-icon fa fa-hand-peace-o"></i>Logout</a>
