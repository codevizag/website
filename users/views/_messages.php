...
if($settings->messaging != 1){
  Redirect::to($us_url_root.'users/admin?err=Messaging+is+disabled');
}
    ...
    foreach($userData as $v1) {
      ...
      <div class="content mt-3">
        ...
        <?php if($count > 0) {?><label><input type="checkbox" class="checkAllMsg" />
          ...
          <form autocomplete="off" name="threads" action="admin?view=_messages" method="post">
                        ...
                        if($today==$last_message) { $last_update = "Today, "; $last_update .= date("g:i A",$lastmessage); }
                          ...
                          <td style="width:200px">
                            <span class="chat-img pull-left" style="padding-left:5px">
                              <a class="nounderline" href="<?=$us_url_root?>users/message?id=<?=$m->id?>">
                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form autocomplete="off" class="form" id="messageSettings" name='messageSettings' action='admin?view=_messages' method='post'>
                      ...
                      <div id="composemass" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form autocomplete="off" name="create_mass_message" action="admin?view=_messages" method="post">
