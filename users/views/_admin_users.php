...
$hooks = getMyHooks(['page' =>'admin?view=users']);
    ...
    if($settings->auto_assign_un==0) {
      ...
      if($validation->passed()) {
        ...
        try {
          ...
          Redirect::to($us_url_root.'users/admin?view=user&id='.$theNewId);
        } catch (Exception $e) {
          die($e->getMessage());
        }
      ...
      <table id="paginate" class='table table-hover table-list-search'>
        ...
        <tbody>
          ...
          foreach ($userData as $v1) {
            ?>
            <tr>
              <td><a class="nounderline" href='admin?view=user&id=<?=$v1->id?>'><?=$v1->id?></a></td>
              <td><a class="nounderline" href='admin?view=user&id=<?=$v1->id?>'><?php if($v1->force_pr==1) {?><font color="red"><i class="fa fa-lock"></i></font><?php } ?></a></td>
              <td><a class="nounderline" href='admin?view=user&id=<?=$v1->id?>'><?=$v1->username?></a></td>
              <td><a class="nounderline" href='admin?view=user&id=<?=$v1->id?>'><?=$v1->fname?> <?=$v1->lname?></a></td>
              <td><a class="nounderline" href='admin?view=user&id=<?=$v1->id?>'><?=$v1->email?></a></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-signup" action="admin?view=users" method="POST">
