...
<div class="topnav" id="myTopnav">
	<div class="nav-center">IoT Student Attendance System</div>
    <?php  
    	if (isset($_SESSION['Admin-name'])) {
			echo '<a href="devices.php">Devices</a>';
			echo '<a href="index.php">Users</a>';
			echo '<a href="ManageUsers.php">Manage Users</a>';
			echo '<a href="UsersLog.php">Users Log</a>';
			echo '<a href="logout.php" style="float: right;">Sign Out</a>';
    		echo '<a href="#" data-toggle="modal" data-target="#admin-account" style="float: right;">'.$_SESSION['Admin-name']. ' <i class="fa fa-user" aria-hidden="true"></i></a>';
    	}
    	else{
			echo '<a href="details.php" style="float: left;">Entries</a>';
