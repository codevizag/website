...
<main>
  <h1 class="slideInDown animated">Signin</h1>
  <h1 class="slideInDown animated" id="reset">Password Reset</h1>
<!-- Log In -->
<section>
    ...
    <div class="login-page">
      <div class="form">
        ...
        <form class="reset-form" action="reset_pass.php" method="post" enctype="multipart/form-data">
          ...
          <p class="message">Remember Your Password? <a href="#">Sign In</a></p>
        </form>
