...
<div class="container">	
	...
	<div id="card" class="weather">
		...
		<div class="details">
			<div class="temp">00<span>0</span></div>
			<div class="right">
				<b><body onload=display_ct();>
					<span id='ct' ></span></b>
				<div id="summary"></div>
			</div>
...
</div><script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/snap.svg/0.4.1/snap.svg-min.js"></script><script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/gsap/1.19.0/TweenMax.min.js"></script>
<script language="JavaScript" type="text/javascript" src="jquery-2.2.4.min.js"></script>
