...
if ($navstyle == 'Default') {
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    <a href="<?= $us_url_root ?>"><img src="<?= $us_url_root ?>users/images/logo-new.png"></a>
    ...
    <body>
        ...
        <div class="list-group border-0 card text-center text-md-left">
          <?php if($user->isLoggedIn()){ //anyone is logged in?>
            ...
            <div class="collapse" id="menu1" data-parent="#sidebar">
              <a href="<?=$us_url_root?>users/admin" class="list-group-item collapsed">Admin Dashboard</a>
              <a href="<?=$us_url_root?>users/admin?view=users" class="list-group-item collapsed">User Management</a>
              <a href="<?=$us_url_root?>users/admin?view=permissions" class="list-group-item collapsed">Page Permissions</a>
              <a href="<?=$us_url_root?>users/admin?view=pages" class="list-group-item collapsed">Page Management</a>
              <a href="<?=$us_url_root?>users/admin?view=logs" class="list-group-item collapsed">System Logs</a>
              <a href="<?=$us_url_root?>users/logout" class="list-group-item collapsed">Logout</a>
            </div>
          <?php } else { ?>
      ...
      <div>
        <div class="text-center">
          <a style="left:-35px;position: relative;" href="<?= $us_url_root ?>"><img src="<?= $us_url_root ?>users/images/logo-new.png"></a>
        </div>
      </div>
    <?php }
    if ($settings->navigation_type == 1) {
    ...
    if ($settings->navigation_type == 0) {
      ...
      <body>
        ...
        <div class="" style="background-color: #023c73;">
          <div class="text-center">
            <a style="right:-35px;position: relative;" href="<?= $us_url_root ?>"><img style="" src="<?= $us_url_root ?>users/images/logo-new.png"></a>
          </div>
        </div>
      <?php }
      if ($settings->navigation_type == 1) {
